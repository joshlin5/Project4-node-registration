...
app.get('/user/exists',(req,res)=>{
	...
	res.json({exists: !!getUser(userid)})
})
...
app.post('/user', (req, res) => {
	...
	const userSalt = Date.now().toString()
	const hash = computeHash(password, userSalt)
	const userObj = {userid: userid, name: name, salt: userSalt, passwordHash: hash}
	console.log(userObj)
	saveUser(userObj)
